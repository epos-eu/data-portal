...
export class NotificationComponent implements OnInit {
  ...
  @Input() type = UserNotificationService.TYPE_INFO;
  @Input() id = '';
  ...
  ngOnInit(): void {
    switch (this.type) {
      case UserNotificationService.TYPE_INFO:
        this.icon = 'info';
        break;
      case UserNotificationService.TYPE_WARNING:
        this.icon = 'warning';
        break;
      case UserNotificationService.TYPE_ERROR:
        this.icon = 'error';
        break;
    }
  }
